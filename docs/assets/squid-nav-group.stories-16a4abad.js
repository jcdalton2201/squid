import"./squid-sub-nav-a7c4584e.js";import{B as i}from"./baseElement-49f2f951.js";import{d as o}from"./defineSquidElement-344f2f43.js";import{i as d,x as h}from"./lit-element-2d3d1b94.js";import"./squid-nav-f0013089.js";var m=d`:host{display:flex}`;class p extends i{static get styles(){return[m]}static get properties(){return{theme:{type:String}}}shouldUpdate(e){return this.querySelectorAll("squid-sub-nav").forEach(a=>this.setTheme(a)),e}firstUpdated(){this.querySelectorAll("squid-nav").forEach(e=>this.setTheme(e))}render(){return h`<slot></slot>`}setTheme(e){this.theme&&(e.setAttribute("theme",this.theme),this.requestUpdate())}}o("squid-nav-group",p);const f={title:"nav"},v=t=>`<squid-nav-group theme='${t.theme}'>
...
//# sourceMappingURL=squid-nav-group.stories-16a4abad.js.map
