import{i as u,x as l}from"./lit-element-85df8e35.js";import{d as p}from"./defineSquidElement-344f2f43.js";import"./squid-radio-30b19b15.js";import{B as c}from"./baseElement-edd97de1.js";import"./squid-input-base-b6539e8b.js";import"./findParentForm-f0d0b1da.js";import"./squidEvents-397fab83.js";var m=u``;class q extends c{static get styles(){return[m]}static get properties(){return{}}get value(){return this.querySelector("squid-radio[checked]")?this.querySelector("squid-radio[checked]").value:""}set value(e){this.querySelector(`squid-radio[value="${e}"]`).checked=!0}constructor(){super(),this.bindMethods(["__onChange","__onFieldsetKeyup"])}async firstUpdated(){this.options=[...this.querySelectorAll("squid-radio")].map(e=>e),this.addEventListener("keydown",this.__onFieldsetKeyup)}render(){return l`
<fieldset>
...
//# sourceMappingURL=squid-radio-group.stories-baf63467.js.map
