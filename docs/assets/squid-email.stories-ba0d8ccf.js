import{S as n}from"./squid-input-3d76c19e.js";import{d as o}from"./defineSquidElement-344f2f43.js";import"./lit-element-2d3d1b94.js";import"./squid-input-base-50233efb.js";import"./baseElement-49f2f951.js";import"./findParentForm-f0d0b1da.js";class i extends n{static get properties(){return{...super.properties}}constructor(){super("email")}}o("squid-email",i);const g={title:"input"},m=e=>`<squid-email ${e.counter?"counter":""} 
                        ${e.disabled?"disabled":""} 
                        ${e.readonly?"readonly":""} 
                        ${e.required?"required":""} 
...
//# sourceMappingURL=squid-email.stories-ba0d8ccf.js.map
