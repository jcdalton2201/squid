import{i as l,x as n}from"./lit-element-85df8e35.js";import{d as o}from"./defineSquidElement-344f2f43.js";import{S as u}from"./squid-input-2d30322a.js";import"./squid-calendar-2614cb0f.js";import"./squid-input-base-b6539e8b.js";import"./baseElement-edd97de1.js";import"./findParentForm-f0d0b1da.js";import"./squidEvents-397fab83.js";var c=l`#container{max-width:200px}#container squid-calendar.hide{display:none}`;class h extends u{static get styles(){return[...super.styles,c]}static get properties(){return{value:{type:String,reflect:!0,converter:{toAttribute(e){return e instanceof Date?this.localization.format(e):e},fromAttribute(e){return e?new Date(e):null}}}}}constructor(){super(),this.bindMethods(["toggleCalendar","selectedValue"]);const e=document.querySelector("html").lang||"en-US";this.dayFormat=this.dayFormat||"2-digit",this.monthFormat=this.monthFormat||"2-digit",this.yearFormat=this.yearFormat||"numeric",this.localization=new Intl.DateTimeFormat(e,{day:this.dayFormat,month:this.monthFormat,year:this.yearFormat})}firstUpdated(){this.buildRefs()}render(){return n`
...
//# sourceMappingURL=squid-datepicker.stories-48156c3a.js.map
