import{i as n,x as d}from"./lit-element-85df8e35.js";import{B as l}from"./baseElement-edd97de1.js";import{d as c}from"./defineSquidElement-344f2f43.js";import{e as t}from"./squidEvents-397fab83.js";import"./squid-button-25e9610d.js";import"./findParentForm-f0d0b1da.js";var p=n`.header{display:flex;flex-direction:row-reverse}.header button{background:transparent;border:none;color:rgba(72,71,71,.75);cursor:pointer;font-size:1.25rem}`;class u extends l{constructor(){super(),this.bindMethods(["hideModal","__documentKeypress"])}static get styles(){return[p]}static get properties(){return{open:{type:Boolean}}}firstUpdated(){this.open&&(this.hideModal(),this.showModal())}render(){return d` <dialog id="${this.id}" ?open=${this.open} >
        <div class="header">
                            <button
...
//# sourceMappingURL=squid-dialog.stories-c62f6da4.js.map
